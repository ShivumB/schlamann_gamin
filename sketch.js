...
function setup() {
  ...
  correctAnswers = [0, 1, 3, 2, 1, 2];

  answeredCorrectly = 0;
  answeredQuestion = false;
  responses = [
    [
      ["yo", "what's poppin", "you got it wrong!"],
      
      ["WHY", "I CANT BELIEVEIT", "YOU IDIOT", "YOU GOT IT RIGHT!!!"],
    ],
...
function keyPressed() {
  ...
  if (scene == "game") {
    ...
    if (keyCode == 13) {
      if (!answeredQuestion && dialoguePage + 1 < questions.length) {
        dialoguePage ++;
        frame = 0;
